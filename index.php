...
<html class="loading">
  ...
  <div class="content-body">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>𓆩𝗫𝗲𝗿𝗿𝗼𝘅𓆪「Zone ↯」 </strong></h4>
    ...
    <option </option>
	            		...
	            		<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1cvv.php">Stripe Charge CVV/CCN (EUR/USDT)</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1cnn.php">Stripe Charge CVV/CCN (EUR/USDT)</option>
      <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/ashburn.php">Ashburn Charge CVV/CCN (EUR/USDT)</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/edumail.php">Panel Stripe Charge CVV/CCN (EUR/USDT)</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/inr1cnn.php">Stripe Charge CVV/CCN (EUR/USDT)</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eur1cvv.php">Stripe Charge CVV/CCN (EUR/USDT)</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/shopify.php">Shopify Charge CVV/CCN (EUR/USDT)</option>
</select>
	<br>										
...
<footer>
  <p>Special Thanks:- <a href="https://t.me/xerrox_army">𓆩𝗫𝗲𝗿𝗿𝗼𝘅𓆪「Zone ↯」</a></p>
</footer>
<script>
