...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);  
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');  
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=inr&payment_method_types[]=card&description=AlwaysSahil Donation&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
echo "<br><b>Result1: </b> $result1<br>";
echo "<br><b>Result1: </b> $result2<br>";
curl_close($ch);
ob_flush();
?>